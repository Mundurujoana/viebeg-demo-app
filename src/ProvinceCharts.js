  ...
  return (
    <>
      ...
      <div className="chart-container">
        <h2 className='chart-heading'> {selectedProvince} Top Three Customers with the Highest Credit Score</h2>
      ...
      <div className="chart-container">
        <h2 className='chart-heading'> {selectedProvince} Top Three Customers with the Highest Total Amount</h2>
        <div className="center">
          <ResponsiveContainer width="90%" height={400} >
